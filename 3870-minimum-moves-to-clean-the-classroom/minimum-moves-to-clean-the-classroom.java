    ...
    public int minMoves(String[] classroom, int energy) {
        ...
        while (!frontier.isEmpty()) {
            ...
            while (levelSize-- > 0) {
                 ...
                 */
                if (cur.power < strongest[cur.cleaned][cur.cell] || cur.power == 0) {
                    continue;
                }
                ...
                for (int[] d : STEP) {
                    int nr = r + d[0];
                    int nc = c + d[1];
                    if (!inside(nr, nc, height, width) || room[nr][nc] == 'X') {
                        continue;
                    }
                    ...
                    frontier.addLast( new State(nextCell, nextMask, nextPower) );
                }
            }
            moves++;
        }
